 ...
 async function handleRegisterCustomer( data: FormData){
  ...
  return (
    <form className="flex flex-col mt-6" onSubmit={handleSubmit(handleRegisterCustomer)}>
     <label className="mb-1 tex-lg font-medium">Nome completo</label>
      <Input
        type="text"
        name="name"
      ...
      <section className="flex gap-2 my-2 flex-col sm:flex-row">
        ...
        <label className="mb-1 tex-lg font-medium">Telefone</label>
          <Input
            type="number"
            name="phone"
        ...
        <div className="flex-1">
        <label className="mb-1 tex-lg font-medium">Email</label>
          <Input
            type="email"
            name="email"
      ...
      <label className="mb-1 tex-lg font-medium">Endereço completo</label>
      <Input
        type="text"
        name="address"
